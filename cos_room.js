...
var QUIZ_BANK = [
    ...
    { q: "[036] [국어] '수도' (Capital City)를 뜻하는 다른 말로, 대한민국의 수도 지명이기도 한 이 단어는 무엇인가?", a: ["서울", "서울특별시", "서울시"], hint: "예문: 미국의 서울은 워싱턴DC입니다." },
    { q: "[037] [철도] 인천역에서 출발하여 서울 영등포역까지 이어지는 이 노선의 이름은 무엇인가?", a: ["경인선"], hint: "대한민국 최초의 철도노선이며, 서울 경(京) + 어질/인천 인(仁)을 따서 만든 노선입니다." },
    { q: "[038] [IT] 웹사이트에서 페이지를 찾을 수 없을 때 뜨는 오류 코드로, KiiKii(키키)가 해당 코드를 기반하여 만든 노래로 큰 이슈를 끈 바 있다. 400번대 오류코드인데, 정확한 코드는 몇 번인가? (400~404 중 하나 선택)", a: ["404", "404번"], hint: "객관식은 힌트를 제공하지 않아요." },
    { q: "[039] [IT] Compact Disk 의 약자로서, 원판에 레이저로 정보를 저장하고 읽는 매체를 무엇이라고 하는가?", a: ["CD", "씨디"], hint: "이 매체에다가 기록하는 행위를 '버닝' (굽기) 라고 합니다. 사실 Compact Disk의 이니셜을 쓰면 그게 정답입니다." },
